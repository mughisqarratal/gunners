...
// Inisialisasi transporter menggunakan kredensial dari .env
 ...
 * @param to - Email tujuan (penerima)
 * @param otp - Kode OTP 4 digit
 */
export const sendOtpEmail = async (to: string, otp: string) => {
  // Path menuju logo di folder public
  ...
  const mailOptions = {
    ...
    `,
    // Melampirkan logo agar bisa dibaca oleh img src="cid:..."
    attachments: [
      {
        filename: "logo.png",
        path: logoPath,
        cid: "logo_gunners", // Harus sama dengan yang ada di tag img src
      },
    ],
  };
